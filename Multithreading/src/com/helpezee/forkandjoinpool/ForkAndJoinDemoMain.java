package com.helpezee.forkandjoinpool;
...
public class ForkAndJoinDemoMain {

	public static void main(String[] args) {
		//Create ForkJoinPool using the default constructor.
	      ForkJoinPool pool = new ForkJoinPool();
	      //Create three FolderProcessor tasks. Initialize each one with a different folder path.
	      FolderProcessor system = new FolderProcessor("D:\\PPTs", "ppt");
	      FolderProcessor apps = new FolderProcessor("D:\\fiserv", "ppt");
	      FolderProcessor documents = new FolderProcessor("D:\\Yamaha", "ppt");
	      ...
	      List<String> results;
	      results = system.join();
	      System.out.printf("PPTs: %d files found.\n", results.size());
	      results = apps.join();
	      System.out.printf("Fiserv: %d files found.\n", results.size());
	      results = documents.join();
	      System.out.printf("Yamaha: %d files found.\n", results.size());
