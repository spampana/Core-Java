package com.helpezee.nestedclasses;

/* Java program to demonstrate how to implement static and non-static 
classes in a java program. */
class OuterClass {

	public static String msg = "GeeksForGeeks";
	public  String msg1 = "GeeksForGeeks";
...
// Static nested class 
	public static class NestedStaticClass {
		...
		public void printMessage() {
			...
			System.out.println("Message from nested static class: " + msg1);// Not allowed
		}
	}
